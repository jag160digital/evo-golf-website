...
PAGES = [{
    ...
    "hero": {
        ...
        "p": "The <strong>Trackman driving range</strong> at Evolution Golf Academy gives golfers from Derby, Nottingham and across Derbyshire tour-level ball data on every single shot. Covered, floodlit bays mean you can practise properly all year round, and you never need to book.",
        "img": "range_night",
        ...
        {"type": "steps", "kick": "How to use the range", "alt": True,
         ...
         "steps": [
             ...
             ("Add a coach when you want one",
              "If the numbers raise a question you cannot answer, book a session in the <a href=\"trackman-teaching-bay.html\">Trackman teaching bay</a> with a PGA Professional and get it explained properly."),
         ]},
        ...
        {"type": "faq", "kick": "Common questions",
         ...
         "qs": [
             ...
             ("How much does the Trackman driving range cost near Derby?",
              "Baskets start from £4 for a small basket, with larger baskets available and better value for longer sessions. Private bay hire is charged separately. Call 07710 582036 to confirm current prices before you travel."),
             ...
             ("How far is the Trackman range from Derby and Nottingham?",
              "We are at Ormonde Fields Golf Club, Nottingham Road, Codnor, Ripley DE5 9RL. That is roughly 15 minutes from Derby city centre and 20 minutes from Nottingham, both on the A610, with free parking on site. See our <a href=\"golf-lessons-derby.html\">golf lessons in Derby</a> and <a href=\"golf-lessons-nottingham.html\">golf lessons in Nottingham</a> pages for directions."),
